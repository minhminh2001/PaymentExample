package com.example.minhpq.paymentexample.ui.fragment;
...
public class CreditsCardFragment extends Fragment {

    private static final String TAG = CreditsCardFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (oneClick) {
            view = inflater.inflate(R.layout.fragment_security_code, container, false);
